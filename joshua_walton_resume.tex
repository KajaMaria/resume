    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{SOAP and REST Web Services}
          {Developed API RESTful Web Services for consumption by JQuery front-end. VBMS reads and updates data from a many external services. Integrations were made to facilitate updates to business logic and changes to external service contracts regularly. Integrations involved developing code to facilitate building data objects that followed WSDL contracts and called various functions. Testing was done using JMockit to ensure successful integrations.}
